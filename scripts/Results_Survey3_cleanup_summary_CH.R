...
#### Load data ####
# survey
survey3 <- read.csv(paste0(dat.dir,'/survey3_for_cleanup.csv'))

# 5 common surveys
survey3.5 <- read.csv(paste0(dat.dir,
                             '/survey3_5_common_paper_selection.csv'))


#### Data Cleanup ####

# Merge survey 3 with the 5 common paper survey result
# drop columns
...
# manual edits with the same category across all entries.
...
# Editing Biodiversity Category (one spp)
# get levels
...
# Editing Biodiversity Category (mult spp)
...
# E_Xing entries (based on email correspondence)
...
# Editing Biodiversity Category (habitat)
...
# Editing P-value (SKIPPED FOR NOW)



#### Data Summaries ####

# Number of entries per paper
...
# Summary of taxa accross papers
...
# Summary of biodiversity metrics
a <- ddply(survey3, .(taxa), summarize,
           # total count of entries     
...
# Summary of effects and their sig

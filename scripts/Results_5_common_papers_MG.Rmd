...
# survey 5 common papers
  survey1.5p <- read.csv("survey1_common_papers.csv", header=T, stringsAsFactors=FALSE, check.names=F)
...
write.table(survey1.5p.rate, paste0(tab.dir,"survey1_5_common_paper_accept_rate.csv"), sep=",")
```
...
write.table(survey1.5p.sel.df2, paste0(dat.dir,'common_papers\\survey1_5_common_paper_selection.csv'), sep=",")
```
...
survey2.5p.sel.df3 <- survey2.5p.sel.df3[,c(16,1:15)]
...
write.table(survey2.5p.sel.df3, paste0(dat.dir,'common_papers\\survey2_5_common_paper_selection.csv'), sep=",")
```
...
write.table(survey3.5p.accept.m, paste0(dat.dir,'common_papers\\survey3_5_common_paper_selection.csv'), sep=",")
```
...
```
  ...
  Please note, this script has already incoporate both Yuqian's section and Yingjie's. There is no two steps any more. 
# 1. Methods summary
...
fname <- paste0(dat.dir, 'survey2_cleaned_', today, '.csv'); fname; survey2_cleaned = fname

...
# Fix paper id 2201 
survey3[which(survey3$paper_id == '2201'),c(2,3,4,5,6,7,8,11,12,14,15,16)]  
survey3[which(survey3$UID == '2201_1'),]  # have different effects
...
# Fix paper id 466 <- tree and shrub metric only, rename shrub and drip first tree
survey3[which(survey3$paper_id == '466'),c(2,3,4,5,6,7,8,11,12,14,15,16)]  
survey3[which(survey3$UID == '466_2'),]  

# Fix paper id 4831 <-
survey3[which(survey3$paper_id == '466'),c(2,3,4,5,6,7,8,11,12,14,15,16)]  
survey3[which(survey3$UID == '466_2'),]  # have different effects
